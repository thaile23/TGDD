...
CREATE TABLE `color_product` (
  ...
  KEY `colorpro_idx` (`product_id`),
  KEY `color_idx` (`color_id`),
  CONSTRAINT `color` FOREIGN KEY (`color_id`) REFERENCES `color` (`color_id`),
  CONSTRAINT `colorpro` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
