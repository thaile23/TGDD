...
CREATE TABLE `phoneTabletDetail` (
  `phoneTabletDetailId` int(11) NOT NULL,
  `brightness` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `chip` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `chipGraphic` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `chipSpeed` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `frontCamera` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `material` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `product_id` int(11) NOT NULL,
  `ram` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rearCamera` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `screenTechnology` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sim` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sizeWeight` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `touchScreen` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `wideScreen` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`phoneTabletDetailId`),
  KEY `phoneTabletProId_idx` (`product_id`),
  CONSTRAINT `phoneTabletProId` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
