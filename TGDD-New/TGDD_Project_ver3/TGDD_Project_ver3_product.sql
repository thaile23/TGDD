...
CREATE TABLE `product` (
  ...
  KEY `manuId_idx` (`manufacturer_id`),
  KEY `Prostatusid_idx` (`product_status_id`),
  CONSTRAINT `Prostatusid` FOREIGN KEY (`product_status_id`) REFERENCES `product_status` (`product_status_id`),
  CONSTRAINT `categoryId` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`),
  CONSTRAINT `manuId` FOREIGN KEY (`manufacturer_id`) REFERENCES `manufacturer` (`manufacturer_id`)
